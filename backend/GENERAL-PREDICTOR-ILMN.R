# Run by typing : R --vanilla --args expressionfile=~/location/ agefile=~/location/ formula=FORMULA-GENERAL-PREDICTOR-ILMN_ID.txt outputtxt=OUTCOME-GENERAL-PREDICTOR-ILMN_ID.txt < GENERAL-PREDICTION.R
...
#write.table(myGENES, "FULL-ILMN-RES-MATRIX.txt", , quote=FALSE, row.names=F, sep="\t")
